...
impl fmt::Display for WaitlistEntryState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WaitlistEntryState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WaitlistEntryState {
...
impl From<String> for WaitlistEntryState {
...
impl From<&str> for WaitlistEntryState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WaitlistEntryState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WaitlistEntryState {
