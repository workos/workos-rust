...
#[non_exhaustive]
pub enum AgentInstanceDeletedDataType {
    Delegated,
    Autonomous,
...
impl AgentInstanceDeletedDataType {
...
impl fmt::Display for AgentInstanceDeletedDataType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AgentInstanceDeletedDataType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AgentInstanceDeletedDataType {
...
impl From<String> for AgentInstanceDeletedDataType {
...
impl From<&str> for AgentInstanceDeletedDataType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AgentInstanceDeletedDataType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AgentInstanceDeletedDataType {
