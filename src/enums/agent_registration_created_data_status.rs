...
#[non_exhaustive]
pub enum AgentRegistrationCreatedDataStatus {
    Unverified,
    Verified,
    Expired,
    Revoked,
...
impl AgentRegistrationCreatedDataStatus {
...
impl fmt::Display for AgentRegistrationCreatedDataStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AgentRegistrationCreatedDataStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AgentRegistrationCreatedDataStatus {
...
impl From<String> for AgentRegistrationCreatedDataStatus {
...
impl From<&str> for AgentRegistrationCreatedDataStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AgentRegistrationCreatedDataStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AgentRegistrationCreatedDataStatus {
