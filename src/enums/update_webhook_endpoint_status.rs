...
#[non_exhaustive]
pub enum UpdateWebhookEndpointStatus {
    Enabled,
    Disabled,
...
impl fmt::Display for UpdateWebhookEndpointStatus {
...
impl FromStr for UpdateWebhookEndpointStatus {
...
impl Serialize for UpdateWebhookEndpointStatus {
