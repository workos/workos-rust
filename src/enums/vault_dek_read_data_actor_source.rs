...
#[non_exhaustive]
pub enum VaultDekReadDataActorSource {
    Api,
    Dashboard,
...
impl VaultDekReadDataActorSource {
...
impl fmt::Display for VaultDekReadDataActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for VaultDekReadDataActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for VaultDekReadDataActorSource {
...
impl From<String> for VaultDekReadDataActorSource {
...
impl From<&str> for VaultDekReadDataActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for VaultDekReadDataActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VaultDekReadDataActorSource {
