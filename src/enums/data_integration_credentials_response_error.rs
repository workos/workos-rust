...
#[non_exhaustive]
pub enum DataIntegrationCredentialsResponseError {
    NotInstalled,
...
impl DataIntegrationCredentialsResponseError {
...
impl fmt::Display for DataIntegrationCredentialsResponseError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DataIntegrationCredentialsResponseError {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DataIntegrationCredentialsResponseError {
...
impl From<String> for DataIntegrationCredentialsResponseError {
...
impl From<&str> for DataIntegrationCredentialsResponseError {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DataIntegrationCredentialsResponseError {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DataIntegrationCredentialsResponseError {
