...
#[non_exhaustive]
pub enum DsyncDeactivatedDataState {
    Active,
    Validating,
    InvalidCredentials,
    Inactive,
...
impl DsyncDeactivatedDataState {
...
impl fmt::Display for DsyncDeactivatedDataState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DsyncDeactivatedDataState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DsyncDeactivatedDataState {
...
impl From<String> for DsyncDeactivatedDataState {
...
impl From<&str> for DsyncDeactivatedDataState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DsyncDeactivatedDataState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DsyncDeactivatedDataState {
