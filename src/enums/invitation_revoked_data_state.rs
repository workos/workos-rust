...
#[non_exhaustive]
pub enum InvitationRevokedDataState {
    Pending,
    Accepted,
    Expired,
    Revoked,
...
impl InvitationRevokedDataState {
...
impl fmt::Display for InvitationRevokedDataState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for InvitationRevokedDataState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for InvitationRevokedDataState {
...
impl From<String> for InvitationRevokedDataState {
...
impl From<&str> for InvitationRevokedDataState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for InvitationRevokedDataState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for InvitationRevokedDataState {
