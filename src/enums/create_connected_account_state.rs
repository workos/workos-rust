...
#[non_exhaustive]
pub enum CreateConnectedAccountState {
    Connected,
...
impl CreateConnectedAccountState {
...
impl fmt::Display for CreateConnectedAccountState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for CreateConnectedAccountState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for CreateConnectedAccountState {
...
impl From<String> for CreateConnectedAccountState {
...
impl From<&str> for CreateConnectedAccountState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for CreateConnectedAccountState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for CreateConnectedAccountState {
