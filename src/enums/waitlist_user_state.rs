...
impl fmt::Display for WaitlistUserState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WaitlistUserState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WaitlistUserState {
...
impl From<String> for WaitlistUserState {
...
impl From<&str> for WaitlistUserState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WaitlistUserState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WaitlistUserState {
