...
#[non_exhaustive]
pub enum FlagRuleUpdatedContextActorSource {
    Api,
    Dashboard,
    AdminPortal,
    System,
...
impl FlagRuleUpdatedContextActorSource {
...
impl fmt::Display for FlagRuleUpdatedContextActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for FlagRuleUpdatedContextActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for FlagRuleUpdatedContextActorSource {
...
impl From<String> for FlagRuleUpdatedContextActorSource {
...
impl From<&str> for FlagRuleUpdatedContextActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for FlagRuleUpdatedContextActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for FlagRuleUpdatedContextActorSource {
