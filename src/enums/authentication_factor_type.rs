...
impl fmt::Display for AuthenticationFactorType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AuthenticationFactorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AuthenticationFactorType {
...
impl From<String> for AuthenticationFactorType {
...
impl From<&str> for AuthenticationFactorType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AuthenticationFactorType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AuthenticationFactorType {
