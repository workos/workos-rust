...
impl fmt::Display for VaultOrder {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for VaultOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for VaultOrder {
...
impl From<String> for VaultOrder {
...
impl From<&str> for VaultOrder {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for VaultOrder {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VaultOrder {
