...
#[non_exhaustive]
pub enum SessionRevokedDataStatus {
    Active,
    Expired,
    Revoked,
...
impl fmt::Display for SessionRevokedDataStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SessionRevokedDataStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SessionRevokedDataStatus {
...
impl From<String> for SessionRevokedDataStatus {
...
impl From<&str> for SessionRevokedDataStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SessionRevokedDataStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SessionRevokedDataStatus {
