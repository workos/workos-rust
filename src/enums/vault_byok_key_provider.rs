...
impl fmt::Display for VaultByokKeyProvider {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for VaultByokKeyProvider {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for VaultByokKeyProvider {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            "AWS_KMS" => Self::AwsKms,
            "GCP_KMS" => Self::GcpKms,
            "AZURE_KEY_VAULT" => Self::AzureKeyVault,
            other => Self::Unknown(other.to_string()),
        })
    }
}

impl From<String> for VaultByokKeyProvider {
...
impl From<&str> for VaultByokKeyProvider {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for VaultByokKeyProvider {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VaultByokKeyProvider {
