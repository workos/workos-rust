...
#[non_exhaustive]
pub enum DsyncActivatedDataState {
    Active,
    Validating,
    InvalidCredentials,
    Inactive,
...
impl fmt::Display for DsyncActivatedDataState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DsyncActivatedDataState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DsyncActivatedDataState {
...
impl From<String> for DsyncActivatedDataState {
...
impl From<&str> for DsyncActivatedDataState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DsyncActivatedDataState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DsyncActivatedDataState {
