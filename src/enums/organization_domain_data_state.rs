...
#[non_exhaustive]
pub enum OrganizationDomainDataState {
    Pending,
    Verified,
...
impl OrganizationDomainDataState {
...
impl fmt::Display for OrganizationDomainDataState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for OrganizationDomainDataState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for OrganizationDomainDataState {
...
impl From<String> for OrganizationDomainDataState {
...
impl From<&str> for OrganizationDomainDataState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for OrganizationDomainDataState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for OrganizationDomainDataState {
