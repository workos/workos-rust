...
#[non_exhaustive]
pub enum PipeConnectedAccountConnectionRole {
    Compatibility,
    Standard,
...
impl PipeConnectedAccountConnectionRole {
...
impl fmt::Display for PipeConnectedAccountConnectionRole {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for PipeConnectedAccountConnectionRole {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for PipeConnectedAccountConnectionRole {
...
impl From<String> for PipeConnectedAccountConnectionRole {
...
impl From<&str> for PipeConnectedAccountConnectionRole {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for PipeConnectedAccountConnectionRole {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for PipeConnectedAccountConnectionRole {
