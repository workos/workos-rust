...
#[non_exhaustive]
pub enum ConnectionActivatedDataConnectionType {
    Adfssaml,
    AdpOidc,
    AppleOAuth,
    Auth0Migration,
...
impl ConnectionActivatedDataConnectionType {
...
impl fmt::Display for ConnectionActivatedDataConnectionType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ConnectionActivatedDataConnectionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ConnectionActivatedDataConnectionType {
...
impl From<String> for ConnectionActivatedDataConnectionType {
...
impl From<&str> for ConnectionActivatedDataConnectionType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ConnectionActivatedDataConnectionType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ConnectionActivatedDataConnectionType {
