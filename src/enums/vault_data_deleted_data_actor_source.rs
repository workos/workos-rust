...
#[non_exhaustive]
pub enum VaultDataDeletedDataActorSource {
    Api,
    Dashboard,
...
impl VaultDataDeletedDataActorSource {
...
impl fmt::Display for VaultDataDeletedDataActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for VaultDataDeletedDataActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for VaultDataDeletedDataActorSource {
...
impl From<String> for VaultDataDeletedDataActorSource {
...
impl From<&str> for VaultDataDeletedDataActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for VaultDataDeletedDataActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VaultDataDeletedDataActorSource {
