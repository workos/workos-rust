...
#[non_exhaustive]
pub enum AuditLogConfigurationState {
    Active,
    Inactive,
    Disabled,
...
impl AuditLogConfigurationState {
...
impl fmt::Display for AuditLogConfigurationState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AuditLogConfigurationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AuditLogConfigurationState {
...
impl From<String> for AuditLogConfigurationState {
...
impl From<&str> for AuditLogConfigurationState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AuditLogConfigurationState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AuditLogConfigurationState {
