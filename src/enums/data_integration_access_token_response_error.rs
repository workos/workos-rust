...
#[non_exhaustive]
pub enum DataIntegrationAccessTokenResponseError {
...
impl DataIntegrationAccessTokenResponseError {
...
impl fmt::Display for DataIntegrationAccessTokenResponseError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DataIntegrationAccessTokenResponseError {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DataIntegrationAccessTokenResponseError {
...
impl From<String> for DataIntegrationAccessTokenResponseError {
...
impl From<&str> for DataIntegrationAccessTokenResponseError {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DataIntegrationAccessTokenResponseError {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DataIntegrationAccessTokenResponseError {
