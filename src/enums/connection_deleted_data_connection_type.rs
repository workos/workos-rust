...
#[non_exhaustive]
pub enum ConnectionDeletedDataConnectionType {
    Adfssaml,
    AdpOidc,
    AppleOAuth,
    Auth0Migration,
...
impl ConnectionDeletedDataConnectionType {
...
impl fmt::Display for ConnectionDeletedDataConnectionType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ConnectionDeletedDataConnectionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ConnectionDeletedDataConnectionType {
...
impl From<String> for ConnectionDeletedDataConnectionType {
...
impl From<&str> for ConnectionDeletedDataConnectionType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ConnectionDeletedDataConnectionType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ConnectionDeletedDataConnectionType {
