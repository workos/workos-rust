...
#[non_exhaustive]
pub enum ResourceExportDownloadedDataResourceType {
    Users,
    Organizations,
    Events,
    Sessions,
...
impl ResourceExportDownloadedDataResourceType {
...
impl fmt::Display for ResourceExportDownloadedDataResourceType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ResourceExportDownloadedDataResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ResourceExportDownloadedDataResourceType {
...
impl From<String> for ResourceExportDownloadedDataResourceType {
...
impl From<&str> for ResourceExportDownloadedDataResourceType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ResourceExportDownloadedDataResourceType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ResourceExportDownloadedDataResourceType {
