...
#[non_exhaustive]
pub enum InvitationAcceptedDataState {
    Pending,
    Accepted,
    Expired,
    Revoked,
...
impl InvitationAcceptedDataState {
...
impl fmt::Display for InvitationAcceptedDataState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for InvitationAcceptedDataState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for InvitationAcceptedDataState {
...
impl From<String> for InvitationAcceptedDataState {
...
impl From<&str> for InvitationAcceptedDataState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for InvitationAcceptedDataState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for InvitationAcceptedDataState {
