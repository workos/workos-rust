...
#[non_exhaustive]
pub enum PipeConnectedAccountAuthMethod {
    OAuth,
    ApiKey,
    ClientCredentials,
...
impl PipeConnectedAccountAuthMethod {
...
impl fmt::Display for PipeConnectedAccountAuthMethod {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for PipeConnectedAccountAuthMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for PipeConnectedAccountAuthMethod {
...
impl From<String> for PipeConnectedAccountAuthMethod {
...
impl From<&str> for PipeConnectedAccountAuthMethod {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for PipeConnectedAccountAuthMethod {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for PipeConnectedAccountAuthMethod {
