...
impl fmt::Display for AgentInstanceType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AgentInstanceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AgentInstanceType {
...
impl From<String> for AgentInstanceType {
...
impl From<&str> for AgentInstanceType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AgentInstanceType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AgentInstanceType {
