...
#[non_exhaustive]
pub enum AgentInstanceSessionStatus {
    Active,
    Revoked,
    Expired,
...
impl AgentInstanceSessionStatus {
...
impl fmt::Display for AgentInstanceSessionStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AgentInstanceSessionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AgentInstanceSessionStatus {
...
impl From<String> for AgentInstanceSessionStatus {
...
impl From<&str> for AgentInstanceSessionStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AgentInstanceSessionStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AgentInstanceSessionStatus {
