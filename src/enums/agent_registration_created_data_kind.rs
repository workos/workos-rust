...
#[non_exhaustive]
pub enum AgentRegistrationCreatedDataKind {
    Anonymous,
    ServiceAuth,
    IdentityAssertion,
...
impl AgentRegistrationCreatedDataKind {
...
impl fmt::Display for AgentRegistrationCreatedDataKind {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AgentRegistrationCreatedDataKind {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AgentRegistrationCreatedDataKind {
...
impl From<String> for AgentRegistrationCreatedDataKind {
...
impl From<&str> for AgentRegistrationCreatedDataKind {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AgentRegistrationCreatedDataKind {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AgentRegistrationCreatedDataKind {
