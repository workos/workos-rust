...
#[non_exhaustive]
pub enum ConnectionActivatedDataStatus {
    Linked,
    Unlinked,
...
impl ConnectionActivatedDataStatus {
...
impl fmt::Display for ConnectionActivatedDataStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ConnectionActivatedDataStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ConnectionActivatedDataStatus {
...
impl From<String> for ConnectionActivatedDataStatus {
...
impl From<&str> for ConnectionActivatedDataStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ConnectionActivatedDataStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ConnectionActivatedDataStatus {
