...
#[non_exhaustive]
pub enum CreateUserPasswordHashType {
    Bcrypt,
    FirebaseScrypt,
    Ssha,
    Ssha256,
...
impl CreateUserPasswordHashType {
...
impl fmt::Display for CreateUserPasswordHashType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for CreateUserPasswordHashType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for CreateUserPasswordHashType {
...
impl From<String> for CreateUserPasswordHashType {
...
impl From<&str> for CreateUserPasswordHashType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for CreateUserPasswordHashType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for CreateUserPasswordHashType {
