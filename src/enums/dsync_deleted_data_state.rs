...
#[non_exhaustive]
pub enum DsyncDeletedDataState {
    Active,
    Validating,
    InvalidCredentials,
    Inactive,
...
impl fmt::Display for DsyncDeletedDataState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DsyncDeletedDataState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DsyncDeletedDataState {
...
impl From<String> for DsyncDeletedDataState {
...
impl From<&str> for DsyncDeletedDataState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DsyncDeletedDataState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DsyncDeletedDataState {
