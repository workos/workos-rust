...
#[non_exhaustive]
pub enum DataIntegrationCredentialsType {
    Custom,
    Organization,
...
impl DataIntegrationCredentialsType {
...
impl fmt::Display for DataIntegrationCredentialsType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DataIntegrationCredentialsType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DataIntegrationCredentialsType {
...
impl From<String> for DataIntegrationCredentialsType {
...
impl From<&str> for DataIntegrationCredentialsType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DataIntegrationCredentialsType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DataIntegrationCredentialsType {
