...
#[non_exhaustive]
pub enum ConnectionActivatedDataState {
    Draft,
    Active,
    Validating,
    Inactive,
...
impl ConnectionActivatedDataState {
...
impl fmt::Display for ConnectionActivatedDataState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ConnectionActivatedDataState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ConnectionActivatedDataState {
...
impl From<String> for ConnectionActivatedDataState {
...
impl From<&str> for ConnectionActivatedDataState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ConnectionActivatedDataState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ConnectionActivatedDataState {
