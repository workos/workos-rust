...
#[non_exhaustive]
pub enum DsyncUserUpdatedDataState {
    Active,
    Suspended,
    Inactive,
...
impl DsyncUserUpdatedDataState {
...
impl fmt::Display for DsyncUserUpdatedDataState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DsyncUserUpdatedDataState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DsyncUserUpdatedDataState {
...
impl From<String> for DsyncUserUpdatedDataState {
...
impl From<&str> for DsyncUserUpdatedDataState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DsyncUserUpdatedDataState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DsyncUserUpdatedDataState {
