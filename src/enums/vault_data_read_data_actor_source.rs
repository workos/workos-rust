...
#[non_exhaustive]
pub enum VaultDataReadDataActorSource {
    Api,
    Dashboard,
...
impl VaultDataReadDataActorSource {
...
impl fmt::Display for VaultDataReadDataActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for VaultDataReadDataActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for VaultDataReadDataActorSource {
...
impl From<String> for VaultDataReadDataActorSource {
...
impl From<&str> for VaultDataReadDataActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for VaultDataReadDataActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VaultDataReadDataActorSource {
