...
#[non_exhaustive]
pub enum ResourceExportCreatedDataResourceType {
    Users,
    Organizations,
    Events,
    Sessions,
...
impl ResourceExportCreatedDataResourceType {
...
impl fmt::Display for ResourceExportCreatedDataResourceType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ResourceExportCreatedDataResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ResourceExportCreatedDataResourceType {
...
impl From<String> for ResourceExportCreatedDataResourceType {
...
impl From<&str> for ResourceExportCreatedDataResourceType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ResourceExportCreatedDataResourceType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ResourceExportCreatedDataResourceType {
