...
#[non_exhaustive]
pub enum VaultKekCreatedDataActorSource {
    Api,
    Dashboard,
...
impl VaultKekCreatedDataActorSource {
...
impl fmt::Display for VaultKekCreatedDataActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for VaultKekCreatedDataActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for VaultKekCreatedDataActorSource {
...
impl From<String> for VaultKekCreatedDataActorSource {
...
impl From<&str> for VaultKekCreatedDataActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for VaultKekCreatedDataActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VaultKekCreatedDataActorSource {
