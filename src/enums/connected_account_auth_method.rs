...
#[non_exhaustive]
pub enum ConnectedAccountAuthMethod {
    OAuth,
    ApiKey,
...
impl ConnectedAccountAuthMethod {
...
impl fmt::Display for ConnectedAccountAuthMethod {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ConnectedAccountAuthMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ConnectedAccountAuthMethod {
...
impl From<String> for ConnectedAccountAuthMethod {
...
impl From<&str> for ConnectedAccountAuthMethod {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ConnectedAccountAuthMethod {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ConnectedAccountAuthMethod {
