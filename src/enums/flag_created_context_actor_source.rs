...
#[non_exhaustive]
pub enum FlagCreatedContextActorSource {
    Api,
    Dashboard,
    AdminPortal,
    System,
...
impl FlagCreatedContextActorSource {
...
impl fmt::Display for FlagCreatedContextActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for FlagCreatedContextActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for FlagCreatedContextActorSource {
...
impl From<String> for FlagCreatedContextActorSource {
...
impl From<&str> for FlagCreatedContextActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for FlagCreatedContextActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for FlagCreatedContextActorSource {
