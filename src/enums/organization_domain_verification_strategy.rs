...
impl OrganizationDomainVerificationStrategy {
...
impl fmt::Display for OrganizationDomainVerificationStrategy {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for OrganizationDomainVerificationStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl From<String> for OrganizationDomainVerificationStrategy {
...
impl From<&str> for OrganizationDomainVerificationStrategy {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for OrganizationDomainVerificationStrategy {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for OrganizationDomainVerificationStrategy {
