...
#[non_exhaustive]
pub enum EventContextActorSource {
    Api,
    Dashboard,
    AdminPortal,
    System,
...
impl fmt::Display for EventContextActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for EventContextActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for EventContextActorSource {
...
impl From<String> for EventContextActorSource {
...
impl From<&str> for EventContextActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for EventContextActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for EventContextActorSource {
