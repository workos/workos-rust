...
#[non_exhaustive]
pub enum WebhookEndpointJsonStatus {
    Enabled,
    Disabled,
...
impl WebhookEndpointJsonStatus {
...
impl fmt::Display for WebhookEndpointJsonStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WebhookEndpointJsonStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WebhookEndpointJsonStatus {
...
impl From<String> for WebhookEndpointJsonStatus {
...
impl From<&str> for WebhookEndpointJsonStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WebhookEndpointJsonStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WebhookEndpointJsonStatus {
