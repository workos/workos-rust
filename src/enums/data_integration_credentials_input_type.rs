...
#[non_exhaustive]
pub enum DataIntegrationCredentialsInputType {
    Custom,
    Organization,
...
impl DataIntegrationCredentialsInputType {
...
impl fmt::Display for DataIntegrationCredentialsInputType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DataIntegrationCredentialsInputType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DataIntegrationCredentialsInputType {
...
impl From<String> for DataIntegrationCredentialsInputType {
...
impl From<&str> for DataIntegrationCredentialsInputType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DataIntegrationCredentialsInputType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DataIntegrationCredentialsInputType {
