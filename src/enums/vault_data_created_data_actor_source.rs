...
#[non_exhaustive]
pub enum VaultDataCreatedDataActorSource {
    Api,
    Dashboard,
...
impl VaultDataCreatedDataActorSource {
...
impl fmt::Display for VaultDataCreatedDataActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for VaultDataCreatedDataActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for VaultDataCreatedDataActorSource {
...
impl From<String> for VaultDataCreatedDataActorSource {
...
impl From<&str> for VaultDataCreatedDataActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for VaultDataCreatedDataActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VaultDataCreatedDataActorSource {
