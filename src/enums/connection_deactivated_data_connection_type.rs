...
impl ConnectionDeactivatedDataConnectionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Self::Auth0Migration => "Auth0Migration",
...
impl fmt::Display for ConnectionDeactivatedDataConnectionType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ConnectionDeactivatedDataConnectionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ConnectionDeactivatedDataConnectionType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "Auth0Migration" => Self::Auth0Migration,
...
impl From<String> for ConnectionDeactivatedDataConnectionType {
...
impl From<&str> for ConnectionDeactivatedDataConnectionType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ConnectionDeactivatedDataConnectionType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ConnectionDeactivatedDataConnectionType {
