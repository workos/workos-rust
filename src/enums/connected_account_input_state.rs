...
#[non_exhaustive]
pub enum ConnectedAccountInputState {
    Connected,
...
impl ConnectedAccountInputState {
...
impl fmt::Display for ConnectedAccountInputState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ConnectedAccountInputState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ConnectedAccountInputState {
...
impl From<String> for ConnectedAccountInputState {
...
impl From<&str> for ConnectedAccountInputState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ConnectedAccountInputState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ConnectedAccountInputState {
