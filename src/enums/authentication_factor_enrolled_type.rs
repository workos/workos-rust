...
#[non_exhaustive]
pub enum AuthenticationFactorEnrolledType {
    GenericOtp,
    Sms,
    Totp,
    Webauthn,
...
impl AuthenticationFactorEnrolledType {
...
impl fmt::Display for AuthenticationFactorEnrolledType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AuthenticationFactorEnrolledType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AuthenticationFactorEnrolledType {
...
impl From<String> for AuthenticationFactorEnrolledType {
...
impl From<&str> for AuthenticationFactorEnrolledType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AuthenticationFactorEnrolledType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AuthenticationFactorEnrolledType {
