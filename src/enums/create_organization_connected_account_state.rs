...
#[non_exhaustive]
pub enum CreateOrganizationConnectedAccountState {
    Connected,
...
impl CreateOrganizationConnectedAccountState {
...
impl fmt::Display for CreateOrganizationConnectedAccountState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for CreateOrganizationConnectedAccountState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for CreateOrganizationConnectedAccountState {
...
impl From<String> for CreateOrganizationConnectedAccountState {
...
impl From<&str> for CreateOrganizationConnectedAccountState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for CreateOrganizationConnectedAccountState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for CreateOrganizationConnectedAccountState {
