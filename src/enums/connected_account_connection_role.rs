...
#[non_exhaustive]
pub enum ConnectedAccountConnectionRole {
    Compatibility,
    Standard,
...
impl ConnectedAccountConnectionRole {
...
impl fmt::Display for ConnectedAccountConnectionRole {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ConnectedAccountConnectionRole {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ConnectedAccountConnectionRole {
...
impl From<String> for ConnectedAccountConnectionRole {
...
impl From<&str> for ConnectedAccountConnectionRole {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ConnectedAccountConnectionRole {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ConnectedAccountConnectionRole {
