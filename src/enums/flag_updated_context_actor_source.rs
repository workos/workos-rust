...
#[non_exhaustive]
pub enum FlagUpdatedContextActorSource {
    Api,
    Dashboard,
    AdminPortal,
    System,
...
impl FlagUpdatedContextActorSource {
...
impl fmt::Display for FlagUpdatedContextActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for FlagUpdatedContextActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for FlagUpdatedContextActorSource {
...
impl From<String> for FlagUpdatedContextActorSource {
...
impl From<&str> for FlagUpdatedContextActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for FlagUpdatedContextActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for FlagUpdatedContextActorSource {
