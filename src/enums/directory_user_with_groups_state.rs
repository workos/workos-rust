...
#[non_exhaustive]
pub enum DirectoryUserWithGroupsState {
    Active,
    Suspended,
    Inactive,
...
impl DirectoryUserWithGroupsState {
...
impl fmt::Display for DirectoryUserWithGroupsState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DirectoryUserWithGroupsState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DirectoryUserWithGroupsState {
...
impl From<String> for DirectoryUserWithGroupsState {
...
impl From<&str> for DirectoryUserWithGroupsState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DirectoryUserWithGroupsState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DirectoryUserWithGroupsState {
