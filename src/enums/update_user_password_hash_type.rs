...
impl UpdateUserPasswordHashType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            Self::Bcrypt => "bcrypt",
            Self::FirebaseScrypt => "firebase-scrypt",
            Self::Ssha => "ssha",
...
impl fmt::Display for UpdateUserPasswordHashType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for UpdateUserPasswordHashType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for UpdateUserPasswordHashType {
...
impl From<String> for UpdateUserPasswordHashType {
...
impl From<&str> for UpdateUserPasswordHashType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for UpdateUserPasswordHashType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for UpdateUserPasswordHashType {
