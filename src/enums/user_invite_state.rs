...
impl fmt::Display for UserInviteState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for UserInviteState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for UserInviteState {
...
impl From<String> for UserInviteState {
...
impl From<&str> for UserInviteState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for UserInviteState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for UserInviteState {
