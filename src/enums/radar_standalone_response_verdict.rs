...
#[non_exhaustive]
pub enum RadarStandaloneResponseVerdict {
    Allow,
    Block,
    Challenge,
...
impl RadarStandaloneResponseVerdict {
...
impl fmt::Display for RadarStandaloneResponseVerdict {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for RadarStandaloneResponseVerdict {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for RadarStandaloneResponseVerdict {
...
impl From<String> for RadarStandaloneResponseVerdict {
...
impl From<&str> for RadarStandaloneResponseVerdict {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for RadarStandaloneResponseVerdict {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for RadarStandaloneResponseVerdict {
