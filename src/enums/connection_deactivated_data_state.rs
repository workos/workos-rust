...
#[non_exhaustive]
pub enum ConnectionDeactivatedDataState {
    Draft,
    Active,
    Validating,
    Inactive,
...
impl ConnectionDeactivatedDataState {
...
impl fmt::Display for ConnectionDeactivatedDataState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ConnectionDeactivatedDataState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ConnectionDeactivatedDataState {
...
impl From<String> for ConnectionDeactivatedDataState {
...
impl From<&str> for ConnectionDeactivatedDataState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ConnectionDeactivatedDataState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ConnectionDeactivatedDataState {
