...
#[non_exhaustive]
pub enum SessionCreatedDataStatus {
    Active,
    Expired,
    Revoked,
...
impl fmt::Display for SessionCreatedDataStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SessionCreatedDataStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SessionCreatedDataStatus {
...
impl From<String> for SessionCreatedDataStatus {
...
impl From<&str> for SessionCreatedDataStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SessionCreatedDataStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SessionCreatedDataStatus {
