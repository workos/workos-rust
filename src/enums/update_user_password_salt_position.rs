...
#[non_exhaustive]
pub enum UpdateUserPasswordSaltPosition {
    Prefix,
    Suffix,
...
impl fmt::Display for UpdateUserPasswordSaltPosition {
...
impl FromStr for UpdateUserPasswordSaltPosition {
...
impl Serialize for UpdateUserPasswordSaltPosition {
