...
#[non_exhaustive]
pub enum VaultKekDeletedDataActorSource {
    Api,
    Dashboard,
...
impl VaultKekDeletedDataActorSource {
...
impl fmt::Display for VaultKekDeletedDataActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for VaultKekDeletedDataActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for VaultKekDeletedDataActorSource {
...
impl From<String> for VaultKekDeletedDataActorSource {
...
impl From<&str> for VaultKekDeletedDataActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for VaultKekDeletedDataActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VaultKekDeletedDataActorSource {
