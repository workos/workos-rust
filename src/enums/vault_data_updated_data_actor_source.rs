...
#[non_exhaustive]
pub enum VaultDataUpdatedDataActorSource {
    Api,
    Dashboard,
...
impl VaultDataUpdatedDataActorSource {
...
impl fmt::Display for VaultDataUpdatedDataActorSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for VaultDataUpdatedDataActorSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for VaultDataUpdatedDataActorSource {
...
impl From<String> for VaultDataUpdatedDataActorSource {
...
impl From<&str> for VaultDataUpdatedDataActorSource {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for VaultDataUpdatedDataActorSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for VaultDataUpdatedDataActorSource {
