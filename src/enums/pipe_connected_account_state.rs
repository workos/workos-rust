...
#[non_exhaustive]
pub enum PipeConnectedAccountState {
    Connected,
...
impl PipeConnectedAccountState {
...
impl fmt::Display for PipeConnectedAccountState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for PipeConnectedAccountState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for PipeConnectedAccountState {
...
impl From<String> for PipeConnectedAccountState {
...
impl From<&str> for PipeConnectedAccountState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for PipeConnectedAccountState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for PipeConnectedAccountState {
