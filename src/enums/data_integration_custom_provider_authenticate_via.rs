...
#[non_exhaustive]
pub enum DataIntegrationCustomProviderAuthenticateVia {
    RequestBody,
    BasicAuthHeader,
...
impl DataIntegrationCustomProviderAuthenticateVia {
...
impl fmt::Display for DataIntegrationCustomProviderAuthenticateVia {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DataIntegrationCustomProviderAuthenticateVia {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DataIntegrationCustomProviderAuthenticateVia {
...
impl From<String> for DataIntegrationCustomProviderAuthenticateVia {
...
impl From<&str> for DataIntegrationCustomProviderAuthenticateVia {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DataIntegrationCustomProviderAuthenticateVia {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DataIntegrationCustomProviderAuthenticateVia {
