...
pub struct OrganizationDomainUpdatedData {
    ...
    pub state: Option<OrganizationDomainUpdatedDataState>,
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub verification_strategy: Option<OrganizationDomainUpdatedDataVerificationStrategy>,
