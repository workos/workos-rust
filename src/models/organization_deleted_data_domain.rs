...
pub struct OrganizationDeletedDataDomain {
    ...
    pub state: Option<OrganizationDeletedDataDomainState>,
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub verification_strategy: Option<OrganizationDeletedDataDomainVerificationStrategy>,
