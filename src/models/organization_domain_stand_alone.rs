...
pub struct OrganizationDomainStandAlone {
    ...
    pub state: Option<OrganizationDomainStandAloneState>,
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub verification_strategy: Option<OrganizationDomainStandAloneVerificationStrategy>,
