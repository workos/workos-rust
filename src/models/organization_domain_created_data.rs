...
pub struct OrganizationDomainCreatedData {
    ...
    pub state: Option<OrganizationDomainCreatedDataState>,
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub verification_strategy: Option<OrganizationDomainCreatedDataVerificationStrategy>,
