...
pub struct OrganizationDomainVerifiedData {
    ...
    pub state: Option<OrganizationDomainVerifiedDataState>,
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub verification_strategy: Option<OrganizationDomainVerifiedDataVerificationStrategy>,
