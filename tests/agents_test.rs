...
#[tokio::test]
async fn agents_validate_blueprint_token_round_trip() {
    let server = MockServer::start().await;
    Mock::given(method("POST"))
        .and(path_matcher("/agents/blueprints/test_id/tokens/validate"))
        .respond_with(
            ResponseTemplate::new(200)
                .set_body_string(include_str!("fixtures/agent_token_validation.json")),
        )
        .expect(1)
        .mount(&server)
        .await;
    ...
    let _ = client
        .agents()
        .validate_blueprint_token(
            "test_id",
            workos::agents::ValidateBlueprintTokenParams::new(
                serde_json::from_str(include_str!(
                    "fixtures/agent_blueprints_token_validate_token_request.json"
                ))
                .expect("parse fixture for AgentBlueprintsTokenValidateTokenRequest"),
            ),
        )
        .await;
}
...
#[tokio::test]
async fn agents_validate_blueprint_token_unauthorized() {
    let server = MockServer::start().await;
    let template = ResponseTemplate::new(401).set_body_string("{\"message\":\"Unauthorized\"}");
    Mock::given(method("POST"))
        .and(path_matcher("/agents/blueprints/test_id/tokens/validate"))
...
#[tokio::test]
async fn agents_validate_blueprint_token_not_found() {
    let server = MockServer::start().await;
    let template = ResponseTemplate::new(404).set_body_string("{\"message\":\"Not found\"}");
    Mock::given(method("POST"))
        .and(path_matcher("/agents/blueprints/test_id/tokens/validate"))
...
#[tokio::test]
async fn agents_validate_blueprint_token_rate_limited() {
    let server = MockServer::start().await;
    let template = ResponseTemplate::new(429)
        .insert_header("retry-after", "1")
        .set_body_string("{\"message\":\"Slow down\"}");
...
#[tokio::test]
async fn agents_validate_blueprint_token_server_error() {
    let server = MockServer::start().await;
    let template = ResponseTemplate::new(500).set_body_string("{\"message\":\"Internal error\"}");
    Mock::given(method("POST"))
        .and(path_matcher("/agents/blueprints/test_id/tokens/validate"))
...
#[tokio::test]
async fn agents_validate_blueprint_token_bad_request() {
    let server = MockServer::start().await;
    let template = ResponseTemplate::new(400)
        .set_body_string("{\"code\":\"validation_error\",\"message\":\"Bad request\"}");
    Mock::given(method("POST"))
...
#[tokio::test]
async fn agents_validate_blueprint_token_unprocessable() {
    let server = MockServer::start().await;
    let template = ResponseTemplate::new(422).set_body_string("{\"message\":\"Unprocessable\"}");
    Mock::given(method("POST"))
        .and(path_matcher("/agents/blueprints/test_id/tokens/validate"))
