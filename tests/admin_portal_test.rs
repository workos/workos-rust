...
#[tokio::test]
async fn admin_portal_generate_link_unauthorized() {
    let server = MockServer::start().await;
...
#[tokio::test]
async fn admin_portal_generate_link_not_found() {
    let server = MockServer::start().await;
...
#[tokio::test]
async fn admin_portal_generate_link_rate_limited() {
    let server = MockServer::start().await;
...
#[tokio::test]
async fn admin_portal_generate_link_server_error() {
    let server = MockServer::start().await;
...
#[tokio::test]
async fn admin_portal_generate_link_bad_request() {
    let server = MockServer::start().await;
...
#[tokio::test]
async fn admin_portal_generate_link_unprocessable() {
    let server = MockServer::start().await;
